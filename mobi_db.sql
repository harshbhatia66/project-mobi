...
INSERT INTO `mobi_app_exercise` VALUES (1,'Incline Smith Machine Bench Press','A Smith machine incline bench press is a weightlifting exercise that involves pressing a barbell fixed on a guided vertical track at an incline to target the upper chest muscles.','Chest',28),(2,'Flat Chest Press (Hammer Strength)','The Hammer Strength flat chest press machine is a piece of gym equipment designed for horizontal chest pressing exercises, helping build strength and muscle in the pectoral muscles.','Chest',NULL),(3,'Low to High Rows','Low-to-high rows target upper back and shoulders by pulling from low to high.','Back',NULL),(4,'Dips','Exercise for triceps, chest, and shoulders, performed by lowering and raising the body','Chest',NULL),(5,'Pull Ups','Exercise for upper body strength, performed by pulling up from a hanging position.','Back',NULL),(6,'Incline Chest Flies','Isolation exercise targeting chest muscles, involving a controlled fly motion on an incline bench.','Chest',NULL),(7,'Close Grip Rows','Exercise targeting the upper back and biceps using a narrow hand grip.','Back',NULL),(8,'Shoulder Press (Hammer Strength)','Machine-based exercise for shoulder strength and development using a guided press motion.','Shoulders',NULL),(9,'Incline Curls','Bicep isolation exercise performed on an inclined bench, targeting the upper part of the arm.','Biceps',NULL),(10,'Tricep Pushdowns','Isolation exercise for triceps, involving pushing down a cable attachment.','Triceps',NULL),(11,'Seated Lateral Raises','Shoulder isolation exercise, performed seated, targeting the lateral deltoid muscles for shoulder development.','Shoulders',NULL),(12,'Preacher Curls','Bicep isolation exercise performed on a preacher bench, emphasizing the bicep\'s peak.','Biceps',NULL),(13,'Overhead Tricep Extensions','Isolation exercise for triceps, performed by extending the arms overhead with a weight.','Triceps',NULL),(14,'Hammer Curls','Bicep exercise emphasizing the brachialis muscle, performed with a neutral grip for arm development.','Biceps',NULL),(15,'Lateral Raises (Arsenal Machine)','Isolation exercise for shoulder development, using the Arsenal Machine for lateral deltoid targeting.','Shoulders',NULL),(16,'Rear Delt Fly Machine','Exercise targeting the rear deltoid muscles using a specific machine for posterior shoulder development.','Shoulders',NULL),(17,'Reverse Wrist Curls','Forearm exercise involving wrist flexion in the opposite direction, strengthening the extensor muscles.','Forearms',NULL),(18,'Behind The Back Barbell Wrist Curls','Forearm exercise focusing on wrist flexion using a barbell behind the back.','Forearms',NULL);
...
INSERT INTO `mobi_app_sessionexercise` VALUES (1,1,1),(2,2,1),(3,3,1),(4,4,1),(5,5,1),(6,6,1),(7,7,1),(29,8,5),(30,9,5),(31,10,5),(32,11,5),(33,12,5),(34,13,5),(35,14,5),(36,15,5),(37,16,5),(38,17,5),(39,18,5),(40,1,5);
...
INSERT INTO `mobi_app_set` VALUES (1,12,54.00,NULL,NULL,1),(2,8,59.00,NULL,NULL,1),(3,10,59.00,NULL,NULL,1);
...
INSERT INTO `mobi_app_workoutsession` VALUES (1,'2023-12-27 11:31:36.811475',NULL,NULL,1,1),(5,'2024-01-04 05:13:25.127312',NULL,NULL,1,2);
...
-- Dump completed on 2024-02-02 17:19:44
